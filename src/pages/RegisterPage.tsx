            ...
            <div className="text-xs text-muted-foreground">
              ...
              <ul className="space-y-1">
                <li className="flex items-center">
                  <CheckCircle2 className={`h-3 w-3 mr-1 ${password.length >= 8 ? 'text-green-500' : 'text-muted-foreground'}`} />
                  At least 8 characters
                </li>
                <li className="flex items-center">
                  <CheckCircle2 className={`h-3 w-3 mr-1 ${/[A-Z]/.test(password) ? 'text-green-500' : 'text-muted-foreground'}`} />
                  One uppercase letter
                </li>
                <li className="flex items-center">
                  <CheckCircle2 className={`h-3 w-3 mr-1 ${/[0-9]/.test(password) ? 'text-green-500' : 'text-muted-foreground'}`} />
                  One number
                </li>
              </ul>
            </div>
